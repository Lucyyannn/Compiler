...
if(args.lab == 1 or args.lab == 2):
    ...
    os.system("rm -rf test_output/functional_testIR/*")
    if(args.is_advance==False):
        os.system("python3 test.py testcase/functional_test/Basic test_output/functional_testIR 2 llvm")
    else:
        os.system("python3 test.py testcase/functional_test/Advanced test_output/functional_testIR 2 llvm")
else:
    print("未知lab, 请检查输入")
